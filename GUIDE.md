...
## 4. 备数据（olmOCR，少量冒烟）
```bash
$PY scripts/download/download_olmocr.py --subset 00_documents --split train --chunks 00000
...
$PY scripts/download/pull_sample_olmocr.py            # 30 条 eval 探针 -> data/samples_olmocr/train.jsonl
```
